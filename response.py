...
error_list = [return_error(i) for i in [BadRequest, Unauthorized, Forbidden, NotFound, MethodNotAllowed, TooManyRequest, InternalServerError, RequestEntityTooLarge]]
