...
class EnumerateData:
    ...
    cure_type_dict = {
        '住院': ('普通住院', '外伤住院', '无他方责任意外伤害住院', '分疗程间断住院治疗', '单病种住院', '床日费用住院', '转外诊治住院', '急诊转住院', '自主就医住院'),
        '慢特病': ('门诊特病', '门诊慢病'),
        '门诊': ('普通门诊', '大额普通门诊', '门诊单病种', '生育门诊', '门诊两病', '门诊挂号', '新冠门诊', '残疾人辅助器具门诊'),
        '其他': ('定点药店购药', '18周岁以下苯丙酮尿症及四氢生物蝶呤缺乏症', '18周岁以下苯丙酮尿症', '大病关怀', '计划生育手术费', '计划生育住院', '生育住院', '其他')
    }
