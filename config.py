...
class EnumerateData:
    ...
    authority = {'管理员': ('*', ), '医保局': ('insured_data_list', 'user', 'settle_data_statistic'), '政府': ('insured_data_list', 'user')}
    ...
    cure_type =('门诊慢病', '定点药店购药', '普通门诊', '普通住院', '门诊两病', '单病种住院', '门诊单病种', '门诊特病', '无他方责任意外伤害住院',
