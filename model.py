...
class InsuredData2021(db.Model):
    ...
    own_expense = db.Column(db.Double)
...
class SettleData2021(db.Model):
    ...
    all_expense = db.Column(db.Double)
    self_expense = db.Column(db.Double)
    over_expense = db.Column(db.Double)
    first_expense = db.Column(db.Double)
    inner_expense = db.Column(db.Double)
    start_pay = db.Column(db.Double)
    overall_pay = db.Column(db.Double)
    large_pay = db.Column(db.Double)
    big_pay = db.Column(db.Double)
    rescue_pay = db.Column(db.Double)
    civil_pay = db.Column(db.Double)
    other_pay = db.Column(db.Double)
    all_pay = db.Column(db.Double)
    cash_pay = db.Column(db.Double)
    account_pay = db.Column(db.Double)
    together_pay = db.Column(db.Double)
