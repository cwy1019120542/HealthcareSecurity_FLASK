...
class SettleData2019(db.Model):
    ...
    def data_response(self, number):
        return {"number": number, "id": self.id, "settle_id": self.settle_id, "cure_id": self.cure_id,
                ...
                "evidence_type": self.evidence_type, "all_expense": to_float(self.all_expense), "self_expense": to_float(self.self_expense),
                "over_expense": to_float(self.over_expense), "first_expense": to_float(self.first_expense),
                "inner_expense": to_float(self.inner_expense), "start_pay": to_float(self.start_pay), "overall_pay": to_float(self.overall_pay),
                "large_pay": to_float(self.large_pay), "big_pay": to_float(self.big_pay), "rescue_pay": to_float(self.rescue_pay),
                "civil_pay": to_float(self.civil_pay), "other_pay": to_float(self.other_pay), "all_pay": to_float(self.all_pay),
                "cash_pay": to_float(self.cash_pay), "account_pay": to_float(self.account_pay), "together_pay": to_float(self.together_pay),
                "illness_name": self.illness_name, "cure_type": self.cure_type, "attribute": self.attribute,
