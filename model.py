...
class SettleData2021(db.Model):
    ...
    all_expense = db.Column(db.Float)
    self_expense = db.Column(db.Float)
    over_expense = db.Column(db.Float)
    first_expense = db.Column(db.Float)
    inner_expense = db.Column(db.Float)
    start_pay = db.Column(db.Float)
    overall_pay = db.Column(db.Float)
    large_pay = db.Column(db.Float)
    big_pay = db.Column(db.Float)
    rescue_pay = db.Column(db.Float)
    civil_pay = db.Column(db.Float)
    other_pay = db.Column(db.Float)
    all_pay = db.Column(db.Float)
    cash_pay = db.Column(db.Float)
    account_pay = db.Column(db.Float)
    together_pay = db.Column(db.Float)
