...
class InsuredData2025(db.Model):
    __tablename__ = "insured_data_2025"
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    resident_self_number = db.Column(db.String(30))
    worker_self_number = db.Column(db.String(30))
    name = db.Column(db.String(20))
...
class SettleData2020(db.Model):
    ...
    is_refund = db.Column(db.Boolean)
    overyear_refund = db.Column(db.Enum(*EnumerateData.overyear_refund))
    in_department = db.Column(db.String(60))
    out_department = db.Column(db.String(60))
    in_bed = db.Column(db.String(30))
    illness_bed = db.Column(db.String(30))
    out_bed = db.Column(db.String(30))
    in_diagnose = db.Column(db.String(70))
...
class SettleData2025(db.Model):
    __tablename__ = "settle_data_2025"
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    settle_id = db.Column(db.String(30))
    cure_id = db.Column(db.String(30))
    self_number = db.Column(db.String(30))
...
class FeeData2023(db.Model):
    __tablename__ = "fee_data_2023"
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    settle_id = db.Column(db.String(30))
    cure_id = db.Column(db.String(30))
    advice_id = db.Column(db.String(30))
    hospital_id = db.Column(db.String(20))
    hospital_name = db.Column(db.String(80))
    hospital_place = db.Column(db.Enum(*EnumerateData.hospital_place))
    self_number = db.Column(db.String(30))
    cure_type = db.Column(db.Enum(*EnumerateData.cure_type))
    is_centre = db.Column(db.Boolean)
    number = db.Column(DOUBLE)
    price = db.Column(DOUBLE)
    all_expense = db.Column(DOUBLE)
    limit_expense = db.Column(DOUBLE)
    self_expense_percent = db.Column(DOUBLE)
    self_expense = db.Column(DOUBLE)
    over_expense = db.Column(DOUBLE)
    first_expense = db.Column(DOUBLE)
    inner_expense = db.Column(DOUBLE)
    project_level = db.Column(db.Enum(*EnumerateData.project_level))
    list_number = db.Column(db.String(80))
    list_name = db.Column(db.String(80))
    list_type = db.Column(db.Enum(*EnumerateData.list_type))
    medical_number = db.Column(db.String(80))
    institution_number = db.Column(db.String(80))
    institution_name = db.Column(db.String(80))
    project_type = db.Column(db.Enum(*EnumerateData.project_type))
    name = db.Column(db.String(80))
    specs = db.Column(db.String(30))
    dosage = db.Column(db.String(30))
    docter_number = db.Column(db.String(80))
    docter_name = db.Column(db.String(80))
    is_valid = db.Column(db.Boolean)
    is_limit = db.Column(db.Boolean)
    is_talk = db.Column(db.Boolean)
    operate_date = db.Column(db.DateTime)

class FeeData2024(db.Model):
    __tablename__ = "fee_data_2024"
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    settle_id = db.Column(db.String(30))
    cure_id = db.Column(db.String(30))
    advice_id = db.Column(db.String(30))
...
class FeeData2025(db.Model):
    __tablename__ = "fee_data_2025"
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    settle_id = db.Column(db.String(30))
    cure_id = db.Column(db.String(30))
    advice_id = db.Column(db.String(30))
...
model_dict = {
    ...
    "insured_data_2025": InsuredData2025,
    'user': User,
    ...
    'settle_data_2025': SettleData2025,
    'fee_data_2024': FeeData2024,
    'staff': Staff,
