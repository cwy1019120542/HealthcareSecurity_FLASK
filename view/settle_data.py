...
class SettleData(Base):
    ...
    allowed_parameter = {
        "GET": {'name': ('str', None, "person", False, 20), 'id_number': ('str', None, "person", False, 18), "civil_attribute": ("enum", 'or_', "person", False, None), "orphan_attribute": ("enum", 'or_', "person", False, None),
            ...
            "pay_type": ("enum", None, 'settle_data', False, None), "pay_type_operator": ("enum", None, 'settle_data', False, None), "pay_type_value": ('int', None, 'settle_data', False, None), "hospital_id": ('list', None, "settle_data", False, None), 'is_mid_settle': ('bool', None, 'settle_data', False, None), 'is_use_account': ('bool', None, 'settle_data', False, None), 'overyear_refund': ("enum", None, 'settle_data', False, None), 'is_refund': ('bool', None, 'settle_data', False, None), 'is_valid': ('bool', None, 'settle_data', False, None), "limit": ('int', None, '', False, 1000)
        }
    }
